...
export class RickAndMortyApi {
  ...
  public getCharacters(params?: ParamsType) {
    return this.instance.get<ResponseAppType<CharacterType>>('/character', { params }).then((res) => res.data)
  }
  ...
  public getLocations(params?: ParamsType) {
    return this.instance.get<ResponseAppType<LocationType>>('/location', { params }).then((res) => res.data)
  }
  ...
  public getEpisodes(params?: ParamsType) {
    return this.instance.get<ResponseAppType<EpisodeType>>('/episode', { params }).then((res) => res.data)
  }
